...
readonly PROFILE_VERSION="socket-isolated-nonroot-vision-k8v4-agent-v18"
readonly IMAGE_PROFILE_VERSION="socket-isolated-nonroot-vision-k8v4-agent-v18"
readonly CONTAINER_NAME="qwen38-agent-native"
readonly CONTAINER_LABEL="Qwen_best_model_ever"
readonly IMAGE_TAG="qwen38-vllm:qwen38-27b-nvfp4-k8v4-runtime-v18"
readonly EXPECTED_IMAGE_ID="sha256:1614fda9ee7b3dcad8645ed13f6bec47d7c555f0251427442b80861695fe792a"
...
readonly IMAGE_ARCHIVE_NAME="qwen38-vllm-images-runtime-v18.tar"
readonly IMAGE_ARCHIVE_SHA256="935cfebc326b7e6235f86357a8301832c8371779128c00343ba77b49eef8a8a2"
...
readonly KV_USERS_SCOPE_PATCH_DIFF_SHA256="8691d7839d7c38c9d3a9894ee5620894e79fb757ff7d573066a10aaa8adda00c"
readonly SOURCE_PATCH_MANIFEST_SHA256="36218a825bbc870641f841a9b82592cf31bb76a00bfb5d572620b8eb5d661406"
...
readonly ANTHROPIC_PROTOCOL_PATCHED_FILE_SHA256="91c53df4c593f2e3db9a79d5f325557957bea226b2a66a28f415972f165097c5"
readonly ANTHROPIC_SERVING_PATCHED_FILE_SHA256="b5a15aaae06b874814558fe5cdffc4fc212a5c926c279a1ad654f1ccb3778c2e"
readonly CHAT_PROTOCOL_PATCHED_FILE_SHA256="4b08db096624d63707deb107708e945ffd27310814707a2c7c3f185172a026f4"
...
readonly INPUT_PROCESSOR_PATCHED_FILE_SHA256="01322b12ba61d1e2e8df62cb38c1bdf959e9e1eb504cff2b71bfc50bd5f7c7cf"
readonly REQUEST_PATCHED_FILE_SHA256="987cbd77bf4651996e2d593c793ff3a1fcfb865d6fb0188185b376a614c55195"
...
readonly RESPONSES_PROTOCOL_PATCHED_FILE_SHA256="eb8dfafc484d7c1de99d12c65d624d9764b6336d4c40460a73ee12117ceeca38"
...
readonly KV_CACHE_UTILS_PATCHED_FILE_SHA256="1d80e98548d099bfecc5a789a51a176889d2c77411a014faaf94f0075e90d8c9"
readonly GPU_WORKER_PATCHED_FILE_SHA256="083561f27ca5f0ce4d5c3e133565e13631572947524757035051eb938a067a6e"
...
readonly KV_OFFLOAD_BASE_PATCHED_FILE_SHA256="c707b037abe386e12fc4be35a254ece95c75ad7af7bf1930f2f54f1c5ece9d47"
readonly KV_OFFLOAD_CPU_SPEC_PATCHED_FILE_SHA256="4e658d9969daa2549f6efcb2b0ee37e2de4fe6c3bd6b94c08a987836aa48d843"
readonly KV_OFFLOAD_CPU_MANAGER_PATCHED_FILE_SHA256="3cfd23e73201ab519c6e0f2d849786688f8eac45e278cbab73131c94c790963f"
readonly KV_TIERING_SPEC_PATCHED_FILE_SHA256="483427e773767a1696559eb566b4899dc4fa0751c75c477126d57eb57c714dc0"
readonly KV_TIERING_MANAGER_PATCHED_FILE_SHA256="6c4fc97fbaba3e403cd636be578d8355896ddf8b4aeee14e9e1f86b509c9f87b"
readonly OFFLOAD_CONNECTOR_CONFIG_PATCHED_FILE_SHA256="3e038d98736a4dfc5bd83508bc537fea386273b615e794cba7e56ef1ff95505c"
readonly OFFLOAD_CONNECTOR_SCHEDULER_PATCHED_FILE_SHA256="10b880361bd447567d9695a180fc9cf057c420b5e5a3335ebd61e2854d5075ab"
readonly GENERATE_API_ROUTER_PATCHED_FILE_SHA256="1971dbfd3f481b30db9491280aff517e05e6ac7ff8af4933c3eed24752dc582f"
readonly CLI_ARGS_PATCHED_FILE_SHA256="2c74b481652e1b7154df7836a98eb3ef1377092dc8ac4ae02095160907b5e36e"
readonly COMPLETION_PROTOCOL_PATCHED_FILE_SHA256="abc57aaf4cd0f7f9cb933c7a3773585d72eebf2bd681184b25a6b49fb5190e92"
readonly TITOTO_PROTOCOL_PATCHED_FILE_SHA256="26a416c07c99b7ac642ea316c2177e2b4232b86aa55dbd4e6047b08ab6bd78f9"
...
readonly RUNTIME_DOCKERFILE_SHA256="8e7993cf2b8c4af06b5dfffba9fd5f29c10dd8444f39086db562c2a79a5196e3"
...
readonly CACHE_VOLUME="qwen38-vllm-cache-socket-isolated-nonroot-vision-agent-v18"
...
VLLM_ARGS=(
  ...
  # pre-faulted and page-locked — hard, unswappable host memory). Each block
  # is labelled with the agent whose store wrote it, and pressure gives up
  # whole agents rather than the globally oldest blocks, so what stays
  # resident is a whole context a re-entry can copy instead of prefill.
  --kv-transfer-config
