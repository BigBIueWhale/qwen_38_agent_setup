...
readonly PROFILE_VERSION="single-loopback-vision-k8v4-agent-v12"
readonly CONTAINER_NAME="qwen38-agent-native"
readonly CONTAINER_LABEL="Qwen_best_model_ever"
readonly IMAGE_TAG="qwen38-vllm:qwen38-27b-nvfp4-k8v4-runtime-v12"
readonly EXPECTED_IMAGE_ID="sha256:5d545d85950310cb09bebacba9083a242e8943c92669428eb23468d959f4f2d5"
...
readonly IMAGE_ARCHIVE_NAME="qwen38-vllm-images-runtime-v12.tar"
readonly IMAGE_ARCHIVE_SHA256="7738cf9654f033c529e73e32611c48d85f92684eab5c34f712d95e8e1648e128"
...
readonly RUNTIME_DOCKERFILE_SHA256="01ee13d532707172ad91f0df686eac7854eb1d3f906abfd4117337dcbcb8e3ed"
...
readonly CACHE_VOLUME="qwen38-vllm-cache-single-loopback-vision-agent-v12"
readonly ROOT_TMPFS_OPTIONS="rw,nosuid,nodev,exec,size=4g,mode=0700"
readonly TMP_TMPFS_OPTIONS="rw,nosuid,nodev,exec,size=2g,mode=1777"
readonly RUN_TMPFS_OPTIONS="rw,nosuid,nodev,noexec,size=64m,mode=0755"
